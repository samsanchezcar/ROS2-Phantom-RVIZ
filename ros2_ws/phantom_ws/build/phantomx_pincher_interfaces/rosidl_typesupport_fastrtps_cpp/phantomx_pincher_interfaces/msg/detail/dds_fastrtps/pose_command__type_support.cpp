...
#include "phantomx_pincher_interfaces/msg/detail/pose_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phantomx_pincher_interfaces::msg::PoseCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phantomx_pincher_interfaces::msg::PoseCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phantomx_pincher_interfaces::msg::PoseCommand *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_phantomx_pincher_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<phantomx_pincher_interfaces::msg::PoseCommand>()
{
  return &phantomx_pincher_interfaces::msg::typesupport_fastrtps_cpp::_PoseCommand__handle;
}
